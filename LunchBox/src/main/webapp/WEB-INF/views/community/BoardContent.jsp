...
<body>
				...
				<form action="BoardUpdate.do" method="post">
					...
					<div class="form-group">
						<label>작성자:</label> <input value="${board.mb_id}" name="mb_id"
							id="mb_id" type="text" class="form-control">
					</div>
	...
	<c:forEach var="Comment" items="${list2}">
		<tr>
			...
			<td> <button onclick="location.href='DeleteComment.do?cmt_seq=${Comment.cmt_seq}&article_seq=${board.article_seq}'">삭제</button>  </td>
		</tr>
	</c:forEach>
	</table>
	</div>
	...
	<div class="form-group">
			...
			<form name="comment-form"
				...
				method="post">
				<div class="form-group">
					<input type="hidden" name="mb_id" id="mb_id" value="${board.mb_id}">
					<textarea name="cmt_content" id="cmt_content" placeholder ="댓글을 입력하세요." class="form-control"
						rows="1"></textarea>
				</div>
